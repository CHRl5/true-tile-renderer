...
public interface TrueTileRendererConfig extends Config
{
	...
	@ConfigItem(
		...
		description = "Choose whether to outline only your current combat target or a configured NPC list",
		position = 2
	)
	...
	@ConfigItem(
		keyName = "npcNameList",
		name = "NPC list",
		description = "Comma or newline separated NPC names to render when using Configured list mode",
		position = 3
	)
