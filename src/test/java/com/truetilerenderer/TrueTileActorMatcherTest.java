...
public class TrueTileActorMatcherTest
{
	...
	{
		Set<String> parsed = TrueTileActorMatcher.parseConfiguredNpcNames(" Zebak, WardeN \n zebak\n\n");
	...
	public void currentTargetModeMatchesLocalPlayerInteraction()
	{
		...
		assertTrue(TrueTileActorMatcher.shouldRenderNpc(npc, localPlayer, NpcRenderMode.CURRENT_TARGET, Set.of()));
	}
	...
	public void configuredListModeMatchesNormalizedNpcName()
	{
		...
		assertTrue(TrueTileActorMatcher.shouldRenderNpc(npc, localPlayer, NpcRenderMode.CONFIGURED_LIST, Set.of("the whisperer")));
	}
	...
	public void configuredListModeRejectsUnknownNpc()
	{
		...
		assertFalse(TrueTileActorMatcher.shouldRenderNpc(npc, localPlayer, NpcRenderMode.CONFIGURED_LIST, Set.of("duke sucellus")));
	}
